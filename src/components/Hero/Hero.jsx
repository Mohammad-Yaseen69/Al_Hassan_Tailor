...
const Hero = () => {
    ...
    return (
        <div ref={refrence} className='w-full  h-[100vh] flex flex-col gap-5 items-center justify-center'>
            <div className='gap-5 items-center justify-center flex flex-col relative'>
                <h1
                    id='tx1'
                    className='text-white  max-ss:text-[6.4vw] max-sm:text-[5.5vw]  font-bold font-Montserrat text-[4vw]'>
                    AL-Hassan Tailor
                </h1>

                <p
                    id='tx2'
                    className='w-[50%] max-sm:text-[2.5vw] max-ss:text-[3.3vw]  max-sm:w-[80%] max-ss:w-[90%] text-[1.5vw] text-center text-gray-300'>
